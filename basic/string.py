...
#다음 변수에서 3번째(저)와 6번째(공백) 글자만 출력하세요
a = "오늘 저녁은 치킨이다"
...
#다음 문자열에서 split을 이용해 com만 출력하세요
...
#다음 변수를 이용해 Hi를 3번 출력하세요
a = "Hi"

#-을 80개 출력하세요

#두 변수를 이용해 아래 문장을 출력하세요
#HelloPythonHelloPythonHelloPython
a = "Hello"
b = "Python"

#다음 변수에서 ,을 모두 제거하고 출력하세요
a = "1,234,567,890"
